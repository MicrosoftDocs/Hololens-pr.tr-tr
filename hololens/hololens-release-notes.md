...
- Wi-Fi özellikleri kullanıcı arabirimi Ayarlar -Wi-Fi > **Ağ & İnternet -> Durumu ->** Özellikler'den başlatılamadığına ilişkin sorun düzeltildi.
...
- Hesap OneDrive sorunları varsa (örneğin, parolanız değiştikten sonra) yeni bir şimdi düzelt düğmesi Ayarlar görüntülenir. 
...
[Sayfa Ve Görünürlük için Yeni Ayarlar UrI'ler](#new-settings-uris-for-page-settings-visibility) | Ayarlar/PageVisibilityList ilkesi için 20'den fazla yeni SettingsURIs. | BT Yöneticisi |
...
- Windows Holographic for Business bir Microsoft Bağlı Önbellek uç noktasına http indirme modlarını ve [indirmelerini destekler;](/mem/configmgr/core/plan-design/hierarchy/microsoft-connected-cache) Eşler arası indirme modları ve grup atamaları şu anda HoloLens cihazlar için desteklenmiyor.
- HoloLens, Sunucu Güncelleştirme Hizmetleri uç noktaları için Windows veya teslim iyileştirmesini desteklemez.
- Sorun giderme işlemi, Bağlı Önbellek sunucusunda tanılama gerektirir veya Ayarlar Update HoloLens & Security Troubleshooting Windows Update aracılığıyla HoloLens üzerinde Windows  >    >     >   **toplar.**
...
✔️ [Tanılamayı Yapılandır:](#configuring-fallback-diagnostics-via-settings-app)Geri Dönüş Tanılaması'nın tolere toplayıp toplayamaylarını yapılandırarak.
...
- Güncelleştirmenin yüklenmesine etkiden bir güncelleştirme güvenilirliğini Microsoft Edge. 

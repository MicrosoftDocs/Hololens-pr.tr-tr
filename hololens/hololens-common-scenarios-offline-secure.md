...
ms.locfileid: "126032987"
---
# <a name="common-scenarios--offline-secure-hololens-2"></a>Yaygın Senaryolar – Çevrimdışı Güvenli HoloLens 2

## <a name="overview"></a>Genel Bakış

Bu kılavuz, aşağıdaki kısıtlamalarla güvenli ortamlarda kullanmak üzere bir HoloLens 2'nin kilitlenmesini sağlayan örnek sağlama paketini uygulamaya yönelik kılavuz sağlar:
...
1. Gelişmiş Kurtarma Yardımcı (ARC) aracını [bilgisayarınıza](https://www.microsoft.com/store/productId/9P74Z35SFRS8) Microsoft Store/yükleyin
...
1. Proje açılmalı ve artık Kullanılabilir Özelleştirmeler'in bir listesine sahipsiniz:
   ...
   |     İlkeler/Deneyim/AllowCortana                    |     No                            |     Devre dışı Cortana (mikrofonlar devre dışı bırakılmıştır) olası sorunları ortadan kaldırmak için)                                          |
   ...
   |     İlkeler/Güvenlik/AllowRemoveProvisioningPackage    |     No                            |     Kilitlenmiş bu sağlama paketini herkesin kaldırmasını önler.                                                           |
   |     İlkeler/Sistem/AllowLocation                       |     No                            |     Cihazın konum verilerini izlemesini önler.                                                                        |
   |     İlkeler/WiFi/AllowWiFi                             |     No                            |     Devre dışı Wi-Fi                                                                                                                 |

1. Çalışma Zamanı Ayarlar altında Hesaplar **/ Kullanıcılar / KullanıcıAdı: Holo / Password seçeneğini seçin.**
...
1. 2. HoloLens, Sağlama Paketi'nin çalıştırıldığında şu düğme birleşik  tuşuna basın: Birim Kapalı ve Güç Düğmesi'ne **aynı** anda dokunun.

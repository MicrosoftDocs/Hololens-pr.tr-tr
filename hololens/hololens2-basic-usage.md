...
description: karma gerçeklik 'i bulun ve bt arkadaşlarınızla birlikte HoloLens 2 cihaz kullanma hakkında bu kılavuzu kullanmaya başlayın.
...
Hologramlar dünyasını keşfetmeye hazırlanıyor mu?

Bu kılavuzda şunları sağlayan bir giriş sunulmaktadır:

- Karma Gerçeklik ile etkileşim kurma
- HoloLens 2 ' de hologramlar ile etkileşim kurmak için uygulamalı ve seslerinizi kullanma
- HoloLens üzerinde Windows 10 gezinme (Windows Holographic)

## <a name="discover-mixed-reality"></a>Karma Gerçeklik bulma

HoloLens, hologragram, dünyanın bir parçası oldukları gibi bakmak ve seslerinizi yapmak için dijital dünyayı fiziksel ortamınıza göre blend. Hologramlar her zamanki gibi, her zaman sürekli olarak görebilir, serbestçe hareket edebilir ve kişilerle ve nesneleriyle etkileşime geçebilirsiniz. Bu deneyimi "Karma Gerçeklik" olarak çağırıyoruz.

Holographic çerçevesi, gözlerinizin detaylara en önemli olduğu, diğer bir deyişle, çevre görüntü vizyonunuzu açık bırakabileceğiniz hologramlar konumlandırır. Uzamsal ses sayesinde, sizi arkasında olsa bile, bir hologram dinleyerek bir bulu sağlayabilirsiniz. HoloLens fiziksel ortamınızı anladığından, tablolar ve duvarlar gibi gerçek nesneler üzerinde ve etrafında hologragram yerleştirebilirsiniz.

HoloLens, akıllı telefonunuzu kullanma gibi birçok şey elde etmek. Holographic pencerelerini, menülerini ve düğmelerini dokunarak ve işlemek için ellerinizi kullanabilirsiniz.  

bu temel etkileşimleri öğrendikten sonra HoloLens üzerinde dolaşma bir yapışma olur.

> [!TIP]
> şu anda size yakın bir HoloLens varsa, **İpuçları** uygulama, HoloLens üzerindeki el etkileşimleri için hazır bir uygulamalı öğreticiler sağlar.  
> başlamak **için başlangıç hareketini kullanın veya "** başlat 'a git" deyin ve **İpuçları**' yi seçin.

## <a name="the-hand-tracking-frame"></a>El ile izleme çerçevesi
...
Bir hologram yakınınızda, elinizin üzerine getirin ve Dizin parmağınızın ipucunda bir beyaz halka görünmelidir.  Bu, hologramlar ile dokunmanıza ve bunlarla etkileşime başlamanıza yardımcı olan **dokunma imlece** . Bir şey **seçmek** için dokunmatik imlece **dokunarak buna dokunmanız** yeterlidir. Bir dokunmatik ekran kullanırken olduğu gibi, parmak arkadaşlarınızla içerik yüzeyine **çekerek** içerik **kaydırın** .

Size **yakın bir hologram** elde etmek için, **parmak** izi ve **Dizin parmak izi** ile hologram ve bekletme üzerine bir araya koyun. Go 'ya izin vermek için parmaklarınızı yayınlayın. Bu giriş **hareketini** , karma gerçeklik ana 'da 3B nesneleri ve uygulama pencerelerini taşımak, yeniden boyutlandırmak ve döndürmek için kullanın.

Başlat menüsü bir uygulama kutucuğunda bulacağınız gibi bir **bağlam menüsü** getirmek için dokunmatik ekranda yaptığınız gibi **dokunarak ve basılı tutabilirsiniz** .

## <a name="use-hand-ray-for-holograms-out-of-reach"></a>Hologramlar için el Ray kullanma erişim dışı

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE3ZOum]

Ellerinizi yakın bir holograma olmadığında **dokunma imleci** otomatik olarak gizlenir ve **elışın elinizin** içinden görünür. El ışınlar, bir uzaklıktan hologramlar ile etkileşim kurmanıza olanak tanır.

> [!TIP]
> BT ışınları fark ederseniz, "yan ışınları gizle" diyerek bunları gizleyebilirsiniz. Bunları yeniden görünür hale getirmek için "yandan ışınları göster" deyin.

### <a name="select-using-air-tap"></a>Hava dokunumı kullanarak seçin

**El ışını** kullanarak bir şeyi seçmek için şu adımları izleyin:

1. Öğeyi hedeflemek için Palm 'ınızdan bir el Ray kullanın. Tüm kolunuzu yükseltmeniz gerekmez, dirseğinizden düşük ve rahat bir şekilde haberdar olabilirsiniz.
...
**Hand Ray** kullanarak bir hologram veya kaydırma uygulama penceresi içeriğini almak için, bir **hava Dokunla** başlayın, ancak bunları serbest bırakmak yerine parmaklarınızı birlikte tutun.

El Ray ile aşağıdaki eylemleri gerçekleştirmek için **AIR Tap ve Hold** kullanın:

- **Kaydırın**. Uygulama penceresi içeriğini kaydırmak için, içerikte dokunup basılı tutun ve ardından el ışını yukarı ve aşağı ya da yan yana taşıyın.
- Alın. Uygulama penceresini veya hologram almak için, uygulama başlık çubuğunu veya hologram 'yi el Ray ile hedefleyin ve ardından AIR 'e dokunup basılı tutun.
- **Bağlam menülerini açın**. Bağlam menülerini açmak için, el ile dokunarak ve basılı tutun.

## <a name="start-gesture"></a>Başlangıç hareketi

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE3Wxng]

başlangıç hareketi **Başlat menüsü** açar.  Başlangıç hareketini gerçekleştirmek için, elinizdeki Palm 'niz sayesinde elinizin altında tutun. İç bilek için bir **Başlangıç simgesi** görürsünüz. Diğer elinizin yardımıyla bu simgeye dokunun.  Başlat menüsü, **aradığınız yerde** açılır.

> [!TIP]
>
> - Başlangıç hareketini, elleriniz el ile izleme çerçevesinin içinde olduğu sürece kullanabilirsiniz.  Başlangıç simgesine bakmak zorunda değilsiniz. dirseğini düşük ve rahat tutun ve Başlat menüsü açmak istediğiniz yönü bulun.
> - Başlat menüsü istediğiniz konumda açılmadıysa, yeniden konumlandırmak için kafanızı taşıyın.
...
### <a name="one-handed-start-gesture"></a>Tek elli başlangıç hareketi

> [!IMPORTANT]
> Tek elli başlangıç hareketinin çalışması için:
>
> 1. Kasım 2019 güncelleştirmesine (derleme 18363,1039) veya sonraki bir sürüme güncelleştirmeniz gerekir.
> 1. Göz izlemenin doğru çalışması için, gözlerinizin cihazda ayarlanması gerekir. Bu noktaya baktığındaki başlangıç simgesinin çevresinde daha fazla nokta görmüyorsanız, gözleriniz cihazda [kalibre](/hololens/hololens-calibration#calibrating-your-hololens-2) edilmez.
...
Tüm bu etkileşim etkileşimlerini teste koymaya hazır mısınız?!

yüklü uygulamalarınızı [Başlat menüsü](holographic-home.md) bulacaksınız ve [Microsoft Store](holographic-store-apps.md)HoloLens için ek uygulamalar bulabilirsiniz.

Windows PC 'nin her zaman sürümünde her zaman deneyim başlattığı gibi, HoloLens her zaman açık olduğunda **karma gerçeklik giriş** içinde başlar.  Başlat menüsü kullanarak, app windows 'un yanı sıra, karışık gerçeklik ana 'da da uygulama başlatma ve 3b içerik açabilir ve yerleştirebilirsiniz. Fiziksel alanınızdaki yerleştirmelerin HoloLens, hatırlanır.

**Başlat menüsü** açın, sonra **Ayarlar** uygulama kutucuğunu seçin. Uygulamanın önünde bir uygulama penceresi açılır.

Ayarlar, 2b **uygulama penceresi** kullanan bir HoloLens uygulamasına bir örnektir.  bilgisayar üzerindeki bir Windows uygulamasına çok benzer.

artık **Başlat menüsü** yeniden açabilir ve **İpuçları** uygulama kutucuğunu seçebilirsiniz. Uygulama için bir 3B **uygulama başlatıcısı** , sizin için bir adet görüntülenir. Uygulamayı açmak için, başlatıcı üzerinde **oynat** düğmesini seçmeniz gerekir.

İpuçları, bir **tam ekran uygulama** örneğidir. Modern bir uygulama, çalıştırıldığında karma gerçeklik evinden uzaklaşabilir ve gördüğünüz tek uygulama olur.  çıkmak için Başlat menüsü almanız ve alt kısımdaki **karma gerçeklik giriş** düğmesini seçmeniz gerekir.
